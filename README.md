...
This repository provides a command line interface (CLI) utility that replicates an Amazon Managed Workflows for Apache Airflow (MWAA) environment locally. It comes bundled with Jupyterlab that can assist in airflow development process by providing autocomplete functionality and documentation lookup. For more information on jupyter notebooks and jupyterlab visit [here](https://jupyter.org/)

<img src="./static/images/airflow_local_airflow_ui.png" />
<img src="./static/images/airflow_local_airflow_autocomplete.png" />
<img src="./static/images/airflow_local_airflow_documentation.png" />


## About the CLI

The CLI builds a Docker container image locally that’s similar to a MWAA production image. This allows you to run a local Apache Airflow environment to develop and test DAGs, custom plugins, and dependencies before deploying to MWAA. It also enables you to quickly test airflow's Papermill Operator and ipynb notebooks all at one place.
...
**Note**: There are few warnings like may occur during the build process. One such is displayed below. Jupyter environment and airflow has some package incompatibilities and are therefore safely installed in Python3.7.10 virtual environment. The airflow requirements supersedes jupyterlab's requirements so autocomplete and documentation should never break. However, there maybe a case that some functionality of Jupyter Notebook stops working as it is supposed to. In that case, please create an issue

<img src="./static/images/airflow_local_dependency_errors.png" />
...
<img src="./static/images/airflow_local_running_state.png" />

To stop the local environment, Ctrl+C on the terminal and wait till the local runner and the postgres containers are stopped.

### Step three: Accessing the Jupyter Notebook
Locate the notebook url in the logs generated by the start command. By default jupyter notebook will run on port 8888 and URL will look like http://127.0.0.1:8888/?token=[TOKEN]
Upon clicking on URL, you will be directed to the following page on your system's browser
<img src="./static/images/airflow_local_jupyter_home.png" />
